...
namespace WebSV
{
    ...
    public class _LNMASTWebService : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        [Obsolete]
        public void ThemLNMAST(string acctno, long prinnml, long intdue, long intnmlacr, long rate1, long rate2, long rate3,DateTime lastdate, DateTime opndate, DateTime rlsdate)
        {
            ...
            command.Parameters.Add("p_lastdate",OracleDbType.Long).Value = lastdate;
